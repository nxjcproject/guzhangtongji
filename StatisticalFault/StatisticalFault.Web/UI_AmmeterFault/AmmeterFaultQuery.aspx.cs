using StatisticalFault.Service.AmmeterFault;
using System;
...
{
    public partial class AmmeterFaultQuery : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        {
            DataTable table= AmmeterFaultService.GetAmmeterErrorData(organizationId, startTime, endTime);
